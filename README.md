...
* Need to work on tons of excessive calls and bad code throughout; general refactor (pen name code got sloppy in particular; collection code only works for doubles; etc)
